    ...
    <main>
        <div class="container-fluid">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item active">Song Status / Approved</li>
            </ol>
        </div>
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('browser.notApproved.list')}}">Not Approved</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="{{route('browser.approved')}}">Approved</a>
            </li>
        </ul>
        <div class="card mb-4">
                    ...
                    <table class="table table-bordered text-center" width="100%" cellspacing="0">
                        ...
                        @forelse($musics as $key => $music)
                            <tr>
                                ...
                                <td><a class="btn btn-success">{{$music->status}}</a></td>
                            </tr>
                        @empty
                            <tr>

...
{{--    <div class="row">--}}
{{--        <div class="col-md-6">--}}
{{--            <img style="width: 350px; height: 350px" src="{{asset('storage/'.$playlists[0]->image)}}">--}}
{{--        </div>--}}
{{--        <div class="col-md-6">--}}
{{--            <table class="table" id="table-1">--}}
{{--                <tbody>--}}
{{--                <tr>--}}
{{--                    <td class="table-info" colspan="2">{{$playlists[0]->description}}</td>--}}
{{--                </tr>--}}
{{--                <tr>--}}

{{--                    @foreach($playlists as $key => $listSong)--}}
...
{{--                Auto Play Music Singer: {{$playlists[0]->singer_name}}--}}
{{--            </th>--}}
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="box-image-1">
                    <img src="{{asset('storage/'.$playlists[0]->image)}}">
                </div>

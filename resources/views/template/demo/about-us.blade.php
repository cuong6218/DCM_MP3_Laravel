@extends('template.demo.about-us')
@section('content')
    <!-- ##### Preloader ##### -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="about-thumbnail mb-100">
                        <img src="/Client/img/bg-img/bg-7.jpg" alt="">
                    </div>
                </div>
                <!-- About Content -->
                <div class="col-12 col-lg-6">
                    <div class="about--content mb-100">
                        ...
                        <ul class="key-notes">
                            <li>
                                <div class="check"><img src="/Client/img/core-img/check.png" alt=""></div>
                                Donec id purus eu lectus imperdiet varius
                            </li>
                            <li>
                                <div class="check"><img src="/Client/img/core-img/check.png" alt=""></div>
                                Id purus eu lectus imperdiet var
                            </li>
                            <li>
                                <div class="check"><img src="/Client/img/core-img/check.png" alt=""></div>
                                Donec id purus eu lectus imperdiet varius
    ...
    <div class="career-timeline-area section-padding-100">
                    ...
                    <div class="single-timeline-area d-flex">
                        ...
                        <div class="timeline-content">
                            ...
                            <p>Nulla facilisi. Donec id purus eu lectus imperdiet varius. Curabitur consectetur nunc
                                sem, vitae cursus enim tempor eget. Praesent pellentesque nisi urna, sit amet suscipit
                                ligula posuere id. Aenean id tortor vel quam ornare gravida. Phasellus luctus feugiat
                                nunc, quis vulputate ipsum convallis quis. Integer vel nulla erat. Donec erat metus,
                                luctus quis maximus quis, volutpat eu tellus. Interdum et malesuada fames ac ante ipsum
        ...
        <!-- Side Thumbs -->
        <div class="first-img">
            <img src="/Client/img/bg-img/man.png" alt="">
        </div>
        <div class="second-img">
            <img src="/Client/img/bg-img/microphone.png" alt="">
        </div>
    </div>
                ...
                <div class="col-12">
                    ...
                    <div class="discography-slides owl-carousel">
                        ...
                        <div class="single-discography">
                            <a href="#"><img src="/Client/img/bg-img/d1.jpg" alt=""></a>
                        </div>

                        <!-- Single Discography -->
                        <div class="single-discography">
                            <a href="#"><img src="/Client/img/bg-img/d2.jpg" alt=""></a>
                        </div>

                        <!-- Single Discography -->
                        <div class="single-discography">
                            <a href="#"><img src="/Client/img/bg-img/d3.jpg" alt=""></a>
                        </div>

                        <!-- Single Discography -->
                        <div class="single-discography">
                            <a href="#"><img src="/Client/img/bg-img/d4.jpg" alt=""></a>
                        </div>

                        <!-- Single Discography -->
                        <div class="single-discography">
                            <a href="#"><img src="/Client/img/bg-img/d5.jpg" alt=""></a>
                        </div>

                        <!-- Single Discography -->
                        <div class="single-discography">
                            <a href="#"><img src="/Client/img/bg-img/d6.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>

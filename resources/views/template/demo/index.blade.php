            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
                        <h2>Artist Bio</h2>
                        <h6>Những ca khúc mang đậm dấu ấn của cô ca sĩ với chất giọng đầy nội lực Hương Tràm. Cùng Zing lắng nghe và cảm nhận nhé!</h6>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="about-thumbnail mb-100">
                        <img src="{{asset('storage/'.$singerAll[3]->image)}}" alt="">
                    </div>
                </div>
                <!-- About Content -->
                <div class="col-12 col-lg-6">
                    <div class="about-content mb-100">
                        <h4>Hello, It’s {{$singerAll[3]->singer_name}}</h4>
                        <p>{{$singerAll[3]->description}}</p>
